            ...
            rememberAppPermissionState(
                permissions = listOf(
                    ...
                    AppPermission(
                        ...
                        description = context.getString(R.string.permission_camera),
                        isRequired = true
                    )
                )
            )
            ...
            Row(
                ...
                Column() {
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.notification_permission_neccessary),
...
//            Spacer(modifier = Modifier.size(20.dp))
            ...
            Row(
                ...
                Image(
                    painterResource(R.drawable.camera_permission_icon),
                ...
                Column() {
                    ...
                    Text(
                        text = stringResource(R.string.camera_permission_sub_title),
                        fontSize = 13.sp,
                        color = Color.Gray
                    )
                }
...
//            Spacer(modifier = Modifier.weight(1f))
            ...
            Box(
                ...
                Image(
                    ...
                    painter = painterResource(id = if (isKorea()) R.drawable.btn_confirm else R.drawable.btn_eng_confirm),
