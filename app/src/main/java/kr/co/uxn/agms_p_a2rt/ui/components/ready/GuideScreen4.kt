...
@Composable
fun GuideScreen4(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            if (isKorea()) {
                Image(
                    painter = painterResource(R.drawable.guide_illustration4),
                    contentDescription = "가이드 일러스트4",
                    modifier = Modifier.size(300.dp)
                )
            } else {
                Image(
                    painter = painterResource(R.drawable.guide_eng_illustration4),
                    contentDescription = "가이드 일러스트4",
                    modifier = Modifier.size(300.dp)
                )
            }
            ...
            Text(
                ...
                text = stringResource(R.string.guide_description_4),
                fontSize = 20.sp,
            )
            ...
            Box(
                ...
                Image(
                    ...
                    modifier = Modifier.align(Alignment.Center)
                        .clickable {
                            navController.navigate("GuideScreen5")
                        }
                )
            }
        }
