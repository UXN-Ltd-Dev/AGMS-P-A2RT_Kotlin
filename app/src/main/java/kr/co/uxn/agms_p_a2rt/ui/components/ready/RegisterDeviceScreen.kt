...
import kr.co.uxn.agms_p_a2rt.ble.BleUtils
...
//            Spacer(modifier = Modifier.size(50.dp))
            ...
            Image(
                ...
                painter = painterResource(R.drawable.serial_number_pic_rt),
                                            ...
                                            if (result.isSuccessful) {
                                                ...
                                                if (resultBody != null) {
                                                    if (resultBody.isExists) {
                                                        Log.e("TEST", "deviceType : ${resultBody.deviceType}")
                                                        DataStoreManager.replaceDeviceType(resultBody.deviceType)
