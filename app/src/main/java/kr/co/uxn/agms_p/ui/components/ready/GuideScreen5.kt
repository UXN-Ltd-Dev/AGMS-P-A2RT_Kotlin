...
@Composable
fun GuideScreen5(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            // 이미지
            Image(
                painter = painterResource(R.drawable.guide_illustration5),
                contentDescription = "가이드 일러스트5",
            ...
            Text(
                ...
                text = stringResource(R.string.guide_description_5),
                fontSize = 20.sp,
            )
...
//                    painter = painterResource(id = if(isKorean) R.drawable.btn_next else R.drawable.btn_eng_continue),
                    ...
                    modifier = Modifier.align(Alignment.Center)
                        .clickable {
                            navController.navigate("GuideScreen6")
                        }
                )
            }
        }
