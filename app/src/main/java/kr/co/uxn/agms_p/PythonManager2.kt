...
class PythonManager2 {
    ...
    fun calculateGlucose(glucoseList: List<UserValue>, eventList: List<RequestEventListData>): PythonData? {
        return try {
            ...
            val calList: List<Double> = eventList.map { it.value }
