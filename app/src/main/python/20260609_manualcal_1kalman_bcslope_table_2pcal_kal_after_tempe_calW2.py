...
#         print("sensitivity :", rounded_sensitivity)
#
#         print("original baseCurrent: ", baseCurrent)
#         rounded_baseCurrent = round(baseCurrent, 3)
#         print("baseCurrent :", rounded_baseCurrent)
#
#         print("original bcSlope: ", bcSlope)
#         rounded_bcSlope = round(bcSlope, 3)
#         print("bcSlope :", rounded_bcSlope)
...
class DP:
    ...
    def check_data3(timestamp_list, W1_list, W2_list, temperature_list, alphas, timestamp2_list, BG_list, bcurrents, sensitivities, bcslopes, times):    
        ...
        allBGtstamp = timestamps2.tolist()
        allBG = BGs.tolist()
